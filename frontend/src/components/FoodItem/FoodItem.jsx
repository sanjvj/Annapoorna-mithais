...
const FoodItem = ({ item, onClick }) => {
  return (
    <div onClick={onClick} className='bg-white rounded-lg overflow-hidden w-[180px] h-[370px] lg:w-[218px] flex flex-col gap-auto cursor-pointer'>
      <div className='relative'>
        <img className='w-[180px] h-[167px] lg:w-[218px] lg:h-[217px] object-cover rounded-lg' src={item.image} alt='Food item' />
